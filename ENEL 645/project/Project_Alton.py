...
def create_dataset_from_folder(path: str, transform: transforms.Compose) -> torch.utils.data.Dataset:
    """
    Create a dataset from the images in the given folder path.
    ...
    Returns:
    Dataset: A dataset object created from the images.
    """
...
def main_loop():
    ...
    # train_data_path = "/work/TALC/enel645_2024w/group24/dataset-143-classes/Train"
    # test_data_path = "/work/TALC/enel645_2024w/group24/dataset-143-classes/Test"
    # val_data_path = "/work/TALC/enel645_2024w/group24/dataset-143-classes/Validation"
    ...
    train_dataset = datasets.ImageFolder(os.path.join(dataset_path, 'Train'), transform=torch_vision_transform_train)
    val_dataset = datasets.ImageFolder(os.path.join(dataset_path, 'Validation'), transform=torch_vision_transform_val_test)
    test_dataset = datasets.ImageFolder(os.path.join(dataset_path, 'Test'), transform=torch_vision_transform_val_test)
